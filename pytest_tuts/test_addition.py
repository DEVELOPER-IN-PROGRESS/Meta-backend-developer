'''pytest filename should follow this naming convection ie test_<filename> and similarly
for function testing as well
'''

import addition
import pytest

def test_add():  #testing add() function
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert sc.first_char(input_value).isupper() == True
